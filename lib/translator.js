...
//To do: code this in one function with multiple scripts in sequence
...
module.exports = function(program){ //program == commandline args
  ...
  var geomAdjustor = exec('openjscad ../../CuraEngine/adjust_geometry.jscad -o ../output/test.stl',
  ...
  // var curaScript = '../../CuraEngine/build/CuraEngine slice -j ../../CuraEngine/resources/machines/fdmprinter.json -e0 -l ../output/' + inputFile + './stl -o ../output/' + outputFile + '.gcode'
  var slicing = exec('../../CuraEngine/build/CuraEngine slice -j ../../CuraEngine/resources/machines/fdmprinter.json -e0 -l ../output/test.stl -o ../output/test.gcode',
    function(error, stdout, stderr) {
      console.log('stdout: ' + stdout);
      console.log('stderr: ' + stderr);
      if(error != null){
